    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 80, "Adam", "Nowak", 100 });

            migrationBuilder.InsertData(
                table: "Items",
                columns: new[] { "Id", "Name", "Weight" },
                values: new object[] { 1, "Item 1", 10 });

            migrationBuilder.InsertData(
                table: "Titles",
                columns: new[] { "Id", "Name" },
                values: new object[] { 1, "Tytuł 1" });

            migrationBuilder.InsertData(
                table: "Character_Titles",
                columns: new[] { "CharacterId", "TitleId", "AcquiredAt" },
                values: new object[] { 1, 1, new DateTime(2024, 6, 12, 0, 0, 0, 0, DateTimeKind.Unspecified) });
